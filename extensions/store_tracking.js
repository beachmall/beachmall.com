					...
					if(P && P.datapointer && _app.data[P.datapointer] && _app.data[P.datapointer].order){
						...
						for(var i in plugins){
							if(_app.ext.store_tracking.trackers[i] && _app.ext.store_tracking.trackers[i].enable){
								dump("There are trackers that are enabled. Uncomment '_app.ext.store_tracking.trackers[i](order, plugins[i]);' in store_tracking.callbacks.init.attachHandlers.","warn");
