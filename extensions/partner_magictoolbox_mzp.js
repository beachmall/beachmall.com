...
/*BEACHMALL*/		$tag.wrap("<a href='"+app.u.makeImage({'tag':0,'name':fileName,'b':bgcolor})+"' class='MagicZoomPlus' id='prodBigImage_href_"+pid+"' rel='selectors-change: mouseover; hint: false;' />")
					}
				else	{
