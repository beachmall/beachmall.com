...
var beachmart_catsearch = function() {
	var r = {
...
//you may or may not need it.
		...
		//				app.u.dump("beachmart catsearch Extension Started");
						...
						setTimeout(function(){app.ext.beachmart_catsearch.callbacks.startExtension.onSuccess()},250);
					}
				},
				onError : function (){
				...
				var elasticsearch = {
					"query": {
						"filtered": {
							"query": {
								"query_string": {
									"query": tag, //IS_BESTSELLERS, IS_CLEARANCE, ETC.
									//"query": "IS_BESTSELLER",
									"fields" : ["tags"]
								}
							},
							"filter": {
								"term": {
									...
									//"app_category": "beach accessories beach bags totes beach chairs beach gear beach products"
								}
							}
						}
					}
